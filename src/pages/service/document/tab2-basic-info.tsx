            ...
            <div className={'bg-white w-full flex flex-col items-center justify-center'}>
                <div className={'w-[1200px] h-[1000px] bg-back-select'}>
                    ...
                    <div id={'content'} className="w-full flex flex-col pl-[88px] pt-[33px] ">
                        <div className={'w-full flex flex-row justify-end pr-[38.5px]'}>
                        ...
                        <div className={'w-full flex flex-row'}>
                            <div
                                className="p-2.5 flex flex-col gap-2.5 items-center justify-center shrink-0 w-6 h-6 relative">
                                <div
                                    className="text-[#e82121] text-center absolute left-[calc(50%_-_4px)] top-[calc(50%_-_7px)] flex items-center justify-center"
                            ...
                            <div
                                className="text-_600 text-left relative"
                        ...
                        <div className={'w-full mt-[10px]'}>
                            <div className="border-solid border-0 border-_900 border-b w-[1024px] h-[40px] p-0">
                                <div
                                    className="text-_400 text-left p-0 "
                                    style={{font: "400 22px/150% 'Jost', sans-serif"}}
                                >
                                    자기를 한마디로 소개해보세요 짝꿍이 찾는 중요한 키워드 입니다.{" "}
                                </div>
                            </div>
                        </div>
                ...
                <div className={'flex flex-col gap-[15px] items-start justify-start w-[1200px] h-[588px]'}>
                    ...
                    <div className="bg-backselect flex-1 w-full">
                        ...
                        <div className={'w-full flex ml-[88px]'}>
                            <div className="flex flex-row items-start justify-start h-[60px] w-full">
                                ...
                                <div className={''}>
                                    <select className={'w-[140px] h-[60px]'}>
                                        <option>졸업구분</option>
