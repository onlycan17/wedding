                    ...
                    <div id={'content'} className="w-full flex flex-col pl-[88px] pt-[33px] ">
                        ...
                        <div className={'w-full flex justify-start'}>
                            ...
                            <div className={'ml-[35px] mt-[40px] w-[500px] flex justify-end'}>
                                <div className={'w-full h-[60px]'}>
                                    <input className={'w-full h-[60px] rounded-[5px] border-solid border-_400 border   text-_500 text-right'} />
                                </div>
                            </div>
                        ...
                        <div className={'w-full flex justify-start'}>
                            ...
                            <div className={'mt-[40px] w-[100px] h-[60px]'}>
                                <input type={'number'}
                                       className={'border-0 border-b-2 h-[60px] w-full font-size-16 text-[#4d5053] text-right bg-transparent'}
                                       placeholder={'년'}
                                       max={99}
                                    ...
                                    fields.map((field, index) => (
                                        <div key={field} className={'flex'}>
                                            <div className={'ml-[35px] mt-[30px]'}>
                                                <input type={'text'}
                                                       className={'rounded-[5px] border-solid border-_400 border pr-2.5 pl-2.5 flex flex-row gap-2.5 items-center justify-start text-_500 w-[252px] h-[60px] text-left'}
                                                       placeholder="입력"
                                                       />
                                            </div>
                                            <div className={'ml-[35px] mt-[30px]'}>
                                                <input type={'text'}
                                                       className={'rounded-[5px] border-solid border-_400 border pr-2.5 pl-2.5 flex flex-row gap-2.5 items-center justify-start text-_500 w-[120px] h-[60px] text-left'}
                                                        placeholder="발행처"
                                                       />
                                            </div>
                                            <div className={'ml-[20px]'}></div>
